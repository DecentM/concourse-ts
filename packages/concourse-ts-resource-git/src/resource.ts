...
export type Source = {
   ...
   */
  commit_verification_keys?: Utils.Secret[]
  /**
   ...
   * fingerprint.
   */
  commit_verification_key_ids?: Array<Utils.Secret | string>
  /**
   * GPG keyserver to download the public keys from. Defaults to
   * `hkp://keyserver.ubuntu.com/`.
   */
  gpg_keyserver?: Utils.Secret | string
  /**
  ...
  https_tunnel?: {
     ...
     */
    proxy_user?: Utils.Secret | string
    /**
     * If the proxy requires authenticate, use this password
     */
    proxy_password?: Utils.Secret
  }
  /**
